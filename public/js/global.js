$(function(){
   ...
   if(url.indexOf("?p=home&c=index") != -1){
       $('a[href="?p=home&c=index&a=index"]').css("background-color","#0F99A4");
   }else if(url.indexOf("?p=home&c=category") != -1){
        $('a[href="?p=home&c=category&a=index"]').css("background-color","#0F99A4");
        //category菜单选中样式
        ...
        $('a[href="?p=home&c=promotion&a=index"]').css("background-color","#0F99A4");
   }else if(url.indexOf("?p=home&c=technic") != -1){
        $('a[href="?p=home&c=technic&a=index"]').css("background-color","#0F99A4");
        ...
        var str = url.match(/p=home&c=contact&a=index/)+"";
         if(str != "null"){
           ...
           $('a[href="?p=home&c=contact&a=index"]').css("background-color","#0F99A4");
        }
        
        str = url.match(/p=home&c=contact&a=link/)+"";
         if(str != "null"){
           $('a[href="?p=home&c=contact&a=link&no"]').parent().addClass("current");
           $('a[href="?p=home&c=contact&a=link"]').css("background-color","#0F99A4");
        }
