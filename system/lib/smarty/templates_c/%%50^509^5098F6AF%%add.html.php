<?php /* Smarty version 2.6.19, created on 2016-07-03 09:50:43
         compiled from admin/Good/add.html */ ?>
<!DOCTYPE html>
<!--
...
<html>
    ...
    <body>
        <div style="width:800px;margin-top: 20px;margin-bottom: 200px;">
            <form class="form-horizontal" role="form" onsubmit="return false;" id="add_good_form">
...
?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <label class="checkbox-inline">
                            <input type="radio" id="is_promotion" name="is_promotion" value="1" checked> 是
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" id="is_promotion" name="is_promotion" value="0"> 否
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <img src="public/images/default_head.jpg" name="img1" id="img1" style="cursor: pointer;"/>
                        <img src="public/images/default_head.jpg" name="img2" id="img2" style="cursor: pointer;"/>
                        <img src="public/images/default_head.jpg" name="img3" id="img3" style="cursor: pointer;"/>
                        <img src="public/images/default_head.jpg" name="img4" id="img4" style="cursor: pointer;"/>
                        <img src="public/images/default_head.jpg" name="img5" id="img5" style="cursor: pointer;"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="3" id="good_desc" name="good_desc"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="3" id="shipping_info" name="shipping_info"></textarea>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-sm-offset-9 col-sm-3">
                        <input type="hidden" name="img1_path"  value=""/>
                        <input type="hidden" name="img2_path"  value=""/>
                        <input type="hidden" name="img3_path"  value=""/>
                        <input type="hidden" name="img4_path"  value=""/>
                        <input type="hidden" name="img5_path"  value=""/>
                        <input type="hidden" name="server" value="<?php echo SERVER; ?>" />
                        <button  class="btn btn-primary pull-right" id="go_back">返回</button>
                        <button  class="btn btn-success pull-right " id="save_good">提交</button>                       
                    </div>
                </div>
